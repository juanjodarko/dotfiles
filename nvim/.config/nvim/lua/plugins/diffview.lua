return {
    ...
    require("diffview").setup({
      ...
      hooks = {
        ...
        view_opened = function(view)
          vim.notify(
            string.format("Diffview opened: %s", view.class:name()),
            vim.log.levels.INFO
          )
        end,
      },
  ...
  keys = {
    ...
    { "<leader>gvh", "<cmd>DiffviewFileHistory<cr>", desc = "Diffview: File history (all)" },
    { "<leader>gvf", "<cmd>DiffviewFileHistory %<cr>", desc = "Diffview: File history (current)" },

    -- Merge conflicts
    { "<leader>gvm", "<cmd>DiffviewOpen -m<cr>", desc = "Diffview: Show merge conflicts" },
